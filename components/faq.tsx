import {
  ...
  const faqItems = [
      ...
      answer: (
        <>
          ...
          <ul className="list-disc pl-5 mt-2">
            <li>Encuentros sincrónicos con el instructor y los estudiantes los días martes y jueves de 8:00 pm a 10:00 pm.</li>
    ...
    },
    {
      ...
      answer: "Nuestros programas están avalados por la Universidad Católica de Santo Domingo (UCSD) y Talendig, lo que garantiza su calidad y reconocimiento en el mercado laboral."
    },
    {
      question: "¿Qué sucede si no cumplo con los requisitos de la carrera?",
      answer: "Si no se cumple con los requisitos establecidos, no será posible realizar el programa. Es importante revisar cuidadosamente los requisitos antes de inscribirse para asegurar que puedes comprometerte completamente con el curso."
    }
  ]
